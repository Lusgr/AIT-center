  ...
  return (
    <header className="header">
      ...
      <div className="language-switcher">
        <button className="click" onClick={() => handleLanguageSwitch('am')}>
          <img
            className="es"
        ...
        <button className="click" onClick={() => handleLanguageSwitch('en')}>
          <img
            className="es"
        ...
        <button className="click" onClick={() => handleLanguageSwitch('ru')}>
          <img
            className="es2"
